...
public abstract class Command
{
    ...
    public enum Type { None, Debug, Break, Pause, Continue, Flush, Consume, Sleep, Dialog, Event, EventEnd, GotoLocation, Interrupt, Outfit, Services, Set, Shop, TimePass, ItemAdd, ItemRemove, Conditional, Dialogue }
